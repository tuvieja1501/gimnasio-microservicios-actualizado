package com.gimnasio.equipos.exception;
...
/**
 * Manejo centralizado de excepciones para todos los controllers del microservicio.
 * Captura excepciones esperadas y retorna respuestas REST consistentes.
 */
@ControllerAdvice
